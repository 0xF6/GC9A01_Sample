...
{
    Serial.begin(9600);
    auto spi = new Arduino_HWSPI(T0, A13, SCK, MOSI, -1);
    Serial.println("Inited HWSPI DC:" + String(T0) + ", CS: " + String(A13) + ", SCK: " + String(SCK) + ", DIN(MOSI): " + String(MOSI));
    Serial.println("Display: GC9A01 (IPS)");
    gfx = new Arduino_GC9A01(spi, DAC1 /* RST */);
